...
/**
 * Utility functions for ExperimentTask
 */
 ...
 */
export const getFormConfig = (mode, createHandlers, editHandlers, createState, editState) => {
  ...
  return {
    ...
    taskDescription: isEditMode ? editState.taskDescription : createState.taskDescription,
    origin: isEditMode ? editState.origin : createState.origin,
    llm: isEditMode ? editState.llm : createState.llm,
    searchEngine: isEditMode ? editState.searchEngine : createState.searchEngine,
    geminiApiKey: isEditMode ? editState.geminiApiKey : createState.geminiApiKey,
    googleApiKey: isEditMode ? editState.googleApiKey : createState.googleApiKey,
    googleCx: isEditMode ? editState.googleCx : createState.googleCx,
    RulesExperiment: isEditMode ? editState.RulesExperiment : createState.RulesExperiment,
    SelectedSurvey: isEditMode ? editState.SelectedSurvey : createState.SelectedSurvey,
    selectedQuestionIds: isEditMode
      ? editState.selectedQuestionIds
      : createState.selectedQuestionIds,
    ScoreThreshold: isEditMode ? editState.ScoreThreshold : createState.ScoreThreshold,
    ScoreThresholdmx: isEditMode ? editState.ScoreThresholdmx : createState.ScoreThresholdmx,
    isValidTitleTask: isEditMode ? editState.isValidTitleTask : createState.isValidTitleTask,
    isValidSumaryTask: isEditMode ? editState.isValidSumaryTask : createState.isValidSumaryTask,
