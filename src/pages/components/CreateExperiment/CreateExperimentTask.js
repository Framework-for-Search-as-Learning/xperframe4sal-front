...
const CreateExperimentTask = () => {
  ...
  // --- HANDLERS: Survey & Question Changes ---
  ...
  const handleEditTask = (index) => {
    ...
    // Populate API Keys
    editForm.setGeminiApiKey(task.geminiApiKey || "");
    editForm.setGoogleApikey(task.googleApiKey || "");
    editForm.setGoogleCx(task.googleCx || "");
    ...
    if (task.search_source === "llm") {
      ...
      editForm.setSearchEngine(task.search_model || "google");
    }
