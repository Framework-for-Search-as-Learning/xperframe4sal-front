    ...
    async (experiments) => {
      ...
      try {
        ...
        const experimentsWithParticipantsSet = new Set(
          checks.filter((check) => check.hasParticipants).map((check) => check.id),
        );
    ...
    <div className={styles.researcherContainer}>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="delete-dialog-description">
            {t('delete_experiment_message') || 'Tem certeza que deseja excluir este experimento?'}
          </DialogContentText>
          {experimentToDelete && (
        ...
        <DialogActions sx={{ padding: '16px 24px' }}>
          <Button onClick={cancelDeleteExperiment} color="primary" variant="outlined">
            {t('cancel') || 'CANCELAR'}
          </Button>
      ...
      <div className={styles.headerRow} style={{ marginBottom: '10px' }}>
        ...
        <div className={styles.buttonContainer}>
          ...
          <Button variant="outlined" color="primary" onClick={handleImportExperiment}>
            {t('import')}
          </Button>
          <input
            type="file"
          ...
          <>
            {experimentsOwner?.length > 0 ? (
              ...
              <div className={styles.emptyState}>
                ...
                <Typography variant="body2">{t('experiments_empty_call_to_action')}</Typography>
              </div>
            )}
          </>
        )}
